...
function login(){
    ...
    users.forEach(user => {                                         //Percorre a lista de usuários do sistema e, quando encontra o usuário logado, o adiciona ao sesssioStorage
...
function carregarCadastros(){
    ...
    cadastros.forEach(cadastro => {
        ...
        linha.addEventListener('click', modCad)
